...
function validaPaciente(paciente) {
  ...
  if (paciente.gordura.length==0) erros.push("Gordura nao pode ser Nula")
  if (paciente.peso.length==0) erros.push("Peso nao pode ser Nula")
  if (paciente.altura.length==0) erros.push("Altura nao pode ser Nula")
